...
//AAAAAAAAAAAAAAAAAAAAADIQPQEAAAAAl0qCPJecvUO7gRjtx%2FA7o1tZs5Q%3DcW8IzrOWABtIDqXof8tA4AgTsZpCqdwK23MZsMFcN4St1220rQ
// auth methods
const auth = () => {
    let secret = {
...
const postReplyWithMedia = (client, mediaFilePath, replyTweet) => {
    ...
    initMediaUpload(client, mediaFilePath)
        ...
        .then((mediaId) => {
            let statusObj = {
                status: "Hi @" + replyTweet.user.screen_name + " violation detected!",
